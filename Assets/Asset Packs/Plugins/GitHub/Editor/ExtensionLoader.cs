...
namespace GitHub.Unity {
    ...
    public class ExtensionLoader : ScriptableSingleton<ExtensionLoader> {
        ...
        private static void Initialize() {
            ...
            {
                string scriptPath = Path.Combine(Application.dataPath, "Editor" + Path.DirectorySeparatorChar + "GitHub.Unity" + Path.DirectorySeparatorChar + "EntryPoint.cs");
        ...
        private static void ToggleAssemblies() {
            string path = inSourceMode ? sourceModePath : realPath;
#if NET_4_6
